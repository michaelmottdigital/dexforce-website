<template>
    <Header/>
    <div id="privacy-policy" class="flex justify-center">
    <div class="w-4/5 mt-20 mb-20">
        <h2>Privacy Policy</h2>
        <p>
        At Dexforce Consulting, accessible from http://www.dexforceconsulting.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Dexforce Consulting and how we use it.
        </p>
        <p>
        If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us.
        </p>
        This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Dexforce Consulting. This policy is not applicable to any information collected offline or via channels other than this website.
        ...
        <p>
        You may consult this list to find the Privacy Policy for each of the advertising partners of Dexforce Consulting.
        </p>
        ...
        Note that Dexforce Consulting has no access to or control over these cookies that are used by third-party advertisers.

!(function () {
    var t = {
            ...
            507: function (t, e, n) {
                ...
                t.exports = function (t) {
                    var e,
                        ...
                        b = c(d),
                        w = 0;
                    if ((g && (y = r(y, m > 2 ? arguments[2] : void 0, 2)), null == b || (v == Array && u(b)))) for (n = new v((e = a(d.length))); e > w; w++) (h = g ? y(d[w], w) : d[w]), s(n, w, h);
                    else for (p = (f = b.call(d)).next, n = new v(); !(l = p.call(f)).done; w++) (h = g ? i(f, y, [l.value, w], !0) : l.value), s(n, w, h);
                    return (n.length = w), n;
                };
            },
            9540: function (t, e, n) {
            ...
            7675: function (t, e, n) {
                ...
                t.exports = function (t, e, n, l, h, x, S) {
                    ...
                    if (
                        (C && ((O = i(C.call(new t()))), d !== Object.prototype && O.next && (f || i(O) === d || (u ? u(O, d) : "function" != typeof O[m] && s(O, m, w)), a(O, k, !0, !0), f && (p[k] = w))),
                        h == g &&
                            R &&
                            R.name !== g &&
                            ((E = !0),
                        ...
                        if (((P = { values: j(g), keys: x ? U : j(y), entries: j(b) }), S)) for (A in P) (v || E || !(A in L)) && c(L, A, P[A]);
            ...
            7487: function (t, e, n) {
                ...
                (t.exports = function (t, e, n, a) {
                    ...
                    "function" == typeof n && ("string" != typeof e || i(n, "name") || o(n, "name", e), (s = l(n)).source || (s.source = f.join("string" == typeof e ? e : ""))),
                        t !== r ? (c ? !h && t[e] && (p = !0) : delete t[e], p ? (t[e] = n) : o(t, e, n)) : p ? (t[e] = n) : u(e, n);
            ...
            3036: function (t, e, n) {
                ...
                })("versions", []).push({ version: "3.9.1", mode: r ? "pure" : "global", copyright: "Â© 2021 Denis Pushkarev (zloirock.ru)" });
            },
            966: function (t, e, n) {
                var r = n(6051),
                    o = n(8885),
                ...
                var r = n(3103),
                    ...
                    H = function () {
                        ...
                        var t,
                            ...
                            l = this,
                            h = [];
                        if ((k(l, { type: A, entries: h, updateURL: function () {}, updateSearchParams: N }), void 0 !== c))
                            if (m(c))
                ...
                var r,
                    ...
                    Pt = function (t, e, n, o) {
                        var i,
                            ...
                            y = !1;
                        for (
                            n || ((t.scheme = ""), (t.username = ""), (t.password = ""), (t.host = null), (t.port = null), (t.path = []), (t.query = null), (t.fragment = null), (t.cannotBeABaseURL = !1), (e = e.replace(F, ""))),
                                e = e.replace(M, ""),
                                i = h(e);
                            p <= i.length;
                    ...
                    kt = function () {
                        var t = O(this),
                            ...
                            c = e + ":";
                        return (
                            null !== o ? ((c += "//"), Q(t) && (c += n + (r ? ":" + r : "") + "@"), (c += H(o)), null !== i && (c += ":" + i)) : "file" == e && (c += "//"),
                            (c += t.cannotBeABaseURL ? u[0] : u.length ? "/" + u.join("/") : ""),
                            null !== a && (c += "?" + a),
                            null !== s && (c += "#" + s),
                            c
                        );
    ...
    !(function () {
        ...
        class a {
            ...
            getQuery() {
                return (
                    (t = { embed_domain: this.getDomain(), embed_type: this.embedType, ...this.getUtmParamsFromHost(), ...this.getParamsFromUrl(), ...this.getParamsFromOptions() }),
                    `?${Object.entries(t)
                        .map((t) => {
                            let [e, n] = t;
                                ...
                                (p = [].concat(
                                    ...
                                    f
                                        ? window.requestAnimationFrame(function () {
                                              if (void 0 === m) {
                                                  m = { position: document.body.style.position, top: document.body.style.top, left: document.body.style.left };
                                                  var t = window,
                                                      e = t.scrollY,
                                                      n = t.scrollX,
                                                      r = t.innerHeight;
                ...
                return (
                    (t = this.overlay)
                        ? ((p = p.filter(function (e) {
                          ...
                          f && ((t.ontouchstart = null), (t.ontouchmove = null), h && 0 === p.length && (document.removeEventListener("touchmove", b, c ? { passive: !1 } : void 0), (h = !1))),
                          f
                              ? (function () {
                                    if (void 0 !== m) {
                              ...
                              : (void 0 !== y && ((document.body.style.paddingRight = y), (y = void 0)), void 0 !== v && ((document.body.style.overflow = v), (v = void 0))))
        ...
        const x = {},
            ...
            A = (e) => {
                e.url &&
                    (e.parentElement ?? (e.parentElement = document.scripts[document.scripts.length - 1].parentNode),
                    t(() => {
        ...
        t(() => {
            ...
            Array.from(t).forEach((t) => {
                ((t) => t.getAttribute("data-processed") || "false" === t.getAttribute("data-auto-load"))(t) || (t.setAttribute("data-processed", !0), new a({ parentElement: t, inlineStyles: !0, embedType: "Inline" }).inject());
            });
        });
    })();
